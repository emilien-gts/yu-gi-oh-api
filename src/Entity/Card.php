...
#[UniqueEntity(fields: ['name', 'set'], message: 'This card already exists in this set')]
#[UniqueEntity(fields: 'number', message: 'This number is already used')]
#[UniqueEntity(fields: 'password', message: 'This password is already used')]
class Card
{
    use IdTrait;
